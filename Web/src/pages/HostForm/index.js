            ...
            <div>
                ...
                <Container pt="90px">
                    ...
                    <Box py={30}>
                        ...
                        <DestinationInput type="text" name="amenities" placeholder="WiFi"></DestinationInput>
                    </Box>
                    ...
                    <Box py={30}>
                        ...
                        <DestinationInput onChange={this.handleTextChange.bind(this)} type="text" name="destination" placeholder="Price"></DestinationInput>
                    </Box>

                    <Box py={30}>
                        <Button bg="#60B3DB" fontSize="25px"> Submit </Button>
                    </Box>
