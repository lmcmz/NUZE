...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `details` varchar(500) COMMENT 'brife detail for each client eg.job,lanuages,living place',
...
CREATE TABLE IF NOT EXISTS `host` (
  ...
  `details` varchar(500) COMMENT 'brife detail for each host eg.job,lanuages,living place',
...
CREATE TABLE IF NOT EXISTS `house` (
  ...
  `brife_infor` varchar(70) COMMENT 'house brife information',
